...
const DesktopSidebar: React.FC<DesktopSidebarProps> = ({
  ...
  return (
    <div className={`hidden sm:flex fixed right-0 top-16 bottom-0 bg-gradient-to-b from-black/90 to-gray-900/90 backdrop-blur-lg border-l border-white/20 flex-col space-y-6 overflow-y-auto shadow-2xl transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-80 p-6'}`}>
      <Button onClick={() => setIsCollapsed(!isCollapsed)} className="absolute top-4 -left-4 bg-gray-800 hover:bg-gray-700 text-white rounded-full w-8 h-8 p-0">
